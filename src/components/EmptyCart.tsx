const EmptyCart = () => {
  return (
    <div className=" bg-[#f2f2f2] w-screen h-[90vh]">
      <div className=" flex flex-col justify-center items-center text-center m-auto w-[85vw] sm:w-[55vw] lg:w-[30vw]">
        <svg
          className="cart-svg"
        ...
        <div className="text-center px-2">
          <h3 className="text-2xl sm:text-3xl lg:text-4xl leading-5 md:leading-6 lg:leading-7 font-semibold">
            Your Coffee Cart is Empty
          </h3>
          <p className="text-xl md:text-2xl max-w-full sm:max-w-3/4 lg:max-w-1/2 mt-5 mx-auto mb-0">
            Your perfect brew is just a click away. Start exploring our
            selection to fill your cart!
          </p>
        </div>
      </div>
    </div>
